...
BASE_URL = "https://stathead.com/fbref/player-match-finder.cgi?request=1&year_min=2017-2018&comp_gender=m&force_min_year=1&order_by_asc=1&order_by=date&match_status=1&match=player_game&year_max=2017-2018&comp_type=c-9&weight_type=kgs&is_qualifier=0&timeframe=seasons&height_type=height_meters&cstat[1]=xg&ccomp[1]=gt&cval[1]=0&cstat[2]=shots&ccomp[2]=gt&cval[2]=0&cstat[3]=passes_completed&ccomp[3]=gt&cval[3]=0&cstat[4]=tackles&ccomp[4]=gt&cval[4]=0&cstat[5]=offsides&ccomp[5]=gt&cval[5]=0&offset={offset}"
